...
This project scans watched Binance USDⓈ-M Futures pairs, studies pumped or dumped setups from the last 3 days, saves strategy fingerprints, compares them against current multi-timeframe conditions, and sends Telegram alerts for LONG and SHORT dry-run trades.
